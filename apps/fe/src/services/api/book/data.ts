...
Sách giải thích những thành phần cơ bản của EQ:
- **Tự nhận thức** - Hiểu về cảm xúc của bản thân
- **Tự điều chỉnh** - Kiểm soát và quản lý cảm xúc
- **Động lực** - Sử dụng cảm xúc để đạt mục tiêu
- **Sự đồng cảm** - Hiểu cảm xúc của người khác
- **Kỹ năng xã hội** - Quản lý mối quan hệ hiệu quả

#### Quản lý cảm xúc
Tác phẩm cung cấp những kỹ thuật để:
1. Nhận diện cảm xúc của bản thân và người khác
2. Hiểu nguyên nhân và tác động của cảm xúc
3. Điều chỉnh phản ứng cảm xúc một cách phù hợp

#### Xây dựng mối quan hệ
Sách giúp người đọc xây dựng những mối quan hệ lành mạnh và hiệu quả thông qua việc:
- Lắng nghe tích cực
- Giao tiếp đồng cảm
- Giải quyết xung đột một cách kiến tạo

---

**Tâm trạng phù hợp:** Buồn, Hạnh phúc
...
> **Tóm tắt:** Hari lập luận rằng nhiều nguyên nhân gây trầm cảm bắt nguồn từ mất kết nối xã hội, công việc vô nghĩa, và môi trường. Đề xuất các cách tái kết nối như xây dựng cộng đồng và thay đổi chính sách.

### Nội dung chính
- 🌍 Nguyên nhân xã hội của khủng hoảng tâm lý
- 🤝 Các phương án cộng đồng và can thiệp phi y tế
- 📚 Câu chuyện và bằng chứng thực tế
...
#### Sống chậm lại
Sách khuyến khích người đọc giảm bớt áp lực công việc và dành thời gian cho bản thân.

#### Suy ngẫm về các mối quan hệ
Tác phẩm giúp người đọc hiểu rõ hơn về các mối quan hệ của mình và xây dựng những mối quan hệ lành mạnh hơn.

#### Tìm thấy sự bình yên
Sách giúp người đọc tìm thấy sự bình yên trong tâm hồn bằng cách thực hành thiền định, yoga và những hoạt động thư giãn khác.

---

**Tâm trạng phù hợp:** Tĩnh lặng, Bình yên
...
- **Nhận diện vết thương:** Học cách nhận ra những tổn thương tâm lý từ quá khứ
- **Giải phóng đau khổ:** Phương pháp buông bỏ những gánh nặng và đau khổ
- **Tái sinh nội tâm:** Quá trình hồi phục và tái tạo năng lượng tích cực

#### Thấu hiểu bản thân
Tác phẩm giúp người đọc:
1. Hiểu rõ cơ chế hoạt động của tâm trí và trái tim
2. Có cái nhìn sâu sắc hơn về bản thân
3. Phát triển khả năng tự nhận thức

#### Thực hành thiền định
Những bài tập thiền định đơn giản nhưng hiệu quả:
- Thiền hơi thở cơ bản
- Quán chiếu nội tâm  
- Thiền từ bi và tha thứ

**Phương pháp thiền hơi thở:** 10-15 phút - Tăng sự tập trung  
**Quán chiếu:** 20-30 phút - Tự nhận thức sâu  
**Thiền từ bi:** 15-20 phút - Chữa lành cảm xúc

---

**Tâm trạng phù hợp:** Buồn, Bình yên
...
#### Nghi thức dọn dẹp
Sách giới thiệu những nghi thức dọn dẹp truyền thống của Nhật Bản, giúp người đọc thực hiện công việc này một cách ý thức và trân trọng.

#### Thông điệp tu hành
Tác phẩm truyền tải những thông điệp sâu sắc về sự buông bỏ, chấp nhận và trân trọng những gì mình đang có.

#### Bồi dưỡng tâm hồn
Sách khuyến khích người đọc bồi dưỡng vẻ đẹp tâm hồn thông qua việc tạo ra một không gian sống sạch sẽ, gọn gàng và hài hòa.

---

**Tâm trạng phù hợp:** Bình yên, Tĩnh lặng
...
#### Giải phóng suy nghĩ
Sách giúp người đọc nhận diện và loại bỏ những suy nghĩ tiêu cực, lo lắng và ám ảnh.

#### Tối giản hóa tâm trí
Tác phẩm cung cấp những phương pháp để đơn giản hóa cuộc sống, giảm bớt những áp lực và trách nhiệm không cần thiết.

#### Tìm thấy hạnh phúc
Sách khuyến khích người đọc tập trung vào những điều quan trọng nhất trong cuộc sống và tìm thấy hạnh phúc trong sự giản đơn.
...
#### Cắt giảm đồ đạc
Sách hướng dẫn người đọc cách loại bỏ những đồ đạc không cần thiết và tạo ra một không gian sống gọn gàng, thoải mái.

#### Tối giản suy nghĩ
Tác phẩm khuyến khích người đọc đơn giản hóa suy nghĩ và tập trung vào những điều quan trọng nhất trong cuộc sống.

#### Tìm thấy hạnh phúc
Sách giúp người đọc nhận ra rằng hạnh phúc không nằm ở những thứ vật chất mà ở sự giản đơn và tự do.
...
#### Thư giãn và mơ mộng
Tác phẩm giới thiệu những phương pháp thư giãn đơn giản như thiền định, yoga và đi bộ trong thiên nhiên.

#### Tái tạo năng lượng
Sách giúp người đọc nhận ra rằng việc tạm dừng là cần thiết để tái tạo năng lượng và duy trì sức khỏe tinh thần.
...
Tác phẩm cung cấp những lời khuyên về cách sắp xếp và trang trí không gian sống một cách hiệu quả và thẩm mỹ.
...
#### Khám phá Ikigai
Sách hướng dẫn người đọc cách tìm kiếm Ikigai của mình bằng cách trả lời những câu hỏi quan trọng về đam mê, sở thích, tài năng và giá trị của bản thân.

#### 5 trụ cột của Ikigai
Tác phẩm giới thiệu 5 trụ cột cơ bản của Ikigai:
- **Bắt đầu nhỏ** - Hành động từng bước
- **Giải phóng bản thân** - Buông bỏ lo âu, sợ hãi
- **Hài hòa và bền vững** - Cân bằng giữa công việc và cuộc sống
- **Vui vẻ với hiện tại** - Tận hưởng từng khoảnh khắc
- **Nhận thức bản thân** - Hiểu rõ giá trị và mục tiêu sống

#### Sống trọn khoảnh khắc
Sách khuyến khích người đọc sống trọn khoảnh khắc hiện tại và tận hưởng những điều nhỏ nhặt trong cuộc sống.

---

**Tâm trạng phù hợp:** Hạnh phúc, Bình yên
...
Sách hướng dẫn người đọc cách loại bỏ những đồ đạc, mối quan hệ và thói quen không cần thiết trong cuộc sống.

#### Tập trung vào những điều quan trọng nhất
Tác phẩm khuyến khích người đọc tập trung vào những giá trị, mục tiêu và đam mê của bản thân.

#### Sống một cuộc đời ý nghĩa hơn
Sách giúp người đọc nhận ra rằng hạnh phúc không nằm ở những thứ vật chất mà ở sự giản đơn, tự do và ý nghĩa.
...
#### Khám phá những tổn thương
Sách hướng dẫn người đọc cách nhận diện và khám phá những tổn thương tâm lý từ tuổi thơ.

#### Chữa lành vết thương
Tác phẩm cung cấp những phương pháp và kỹ thuật để chữa lành những vết thương lòng và giải phóng khỏi những cảm xúc tiêu cực.

#### Tái kết nối với bản thể
Sách giúp người đọc tái kết nối với bản thể chân thật và tìm lại sự tự tin, yêu thương và hạnh phúc.
...
Sách giới thiệu những nguyên tắc cơ bản của CBT và cách áp dụng chúng vào cuộc sống hàng ngày.

#### Kiểm soát suy nghĩ
Tác phẩm cung cấp những kỹ thuật để nhận diện và thay đổi những suy nghĩ tiêu cực, lo lắng và ám ảnh.

#### Điều chỉnh cảm xúc
Sách giúp người đọc điều chỉnh cảm xúc và đối phó với những tình huống căng thẳng một cách hiệu quả.
...
#### Trầm cảm là gì?
Sách giải thích những nguyên nhân, triệu chứng và tác động của trầm cảm.

#### Câu chuyện của những người trầm cảm
Tác phẩm ghi lại những câu chuyện真实 của những người đã từng trải qua trầm cảm, giúp người đọc đồng cảm và thấu hiểu hơn.

#### Tìm kiếm sự giúp đỡ
Sách cung cấp những thông tin về các nguồn lực và phương pháp điều trị trầm cảm.
...
#### Wabi Sabi là gì?
Sách giải thích những nguyên tắc cơ bản của Wabi Sabi và cách áp dụng chúng vào cuộc sống hàng ngày.

#### Vẻ đẹp trong sự không hoàn hảo
Tác phẩm khuyến khích người đọc trân trọng những vết nứt, sự cũ kỹ và những dấu ấn của thời gian.

#### Sống chậm rãi và giản dị
Sách giúp người đọc tìm thấy sự bình yên và hạnh phúc trong sự giản đơn của cuộc sống.
...
Sách hướng dẫn người đọc cách nhận diện và chữa lành những tổn thương tâm lý từ quá khứ.

#### Thay đổi suy nghĩ
Tác phẩm cung cấp những kỹ thuật để thay đổi những suy nghĩ tiêu cực và xây dựng những suy nghĩ tích cực hơn.

#### Yêu thương bản thân
Sách giúp người đọc yêu thương bản thân và chấp nhận những khuyết điểm của mình.
...
> **Tóm tắt:** Viktor Frankl chia sẻ trải nghiệm sống còn và phát triển liệu pháp tập trung vào ý nghĩa (logotherapy). Cuốn sách giúp người đọc nhận ra rằng ngay cả trong hoàn cảnh tồi tệ nhất, con người vẫn có thể tìm thấy ý nghĩa và hy vọng.

### Nội dung chính
- 🎯 **Logotherapy:** Tìm ý nghĩa là động lực chính của con người.
- 💪 **Khả năng phục hồi:** Câu chuyện cá nhân minh chứng cho sức mạnh tinh thần.
- 📝 **Ứng dụng thực tế:** Bài tập suy ngẫm giúp xác định giá trị và mục tiêu.
...
> **Tóm tắt:** Cuốn sách giải thích cơ chế chấn thương tâm lý và cách cơ thể lưu giữ ký ức đau thương. Tác giả trình bày các phương pháp trị liệu (EMDR, yoga, trị liệu nhóm) giúp phục hồi.

### Nội dung chính
- 🧬 **Cơ thể và ký ức:** Chấn thương thể hiện qua cơ thể, không chỉ tâm trí.
- 🩹 **Phương pháp chữa lành:** Kết hợp tâm lý trị liệu và thực hành cơ thể.
- 📋 **Hướng dẫn ứng dụng:** Lộ trình phục hồi cho người đọc và chuyên gia.
...
> **Tóm tắt:** Cuốn sách giới thiệu các kỹ thuật CBT giúp xác định và thay đổi mô thức suy nghĩ tiêu cực. Bao gồm bài tập thực hành hàng ngày để cải thiện tâm trạng và giảm trầm cảm.

### Nội dung chính
- 🔍 **Nhận diện suy nghĩ méo mó:** Hướng dẫn ghi chép và phân tích.
- 🛠️ **Kỹ thuật hành động:** Thực hành thay đổi hành vi để cải thiện tâm trạng.
- 📓 **Bài tập chi tiết:** Mẫu và công cụ tự trợ giúp.
...
> **Tóm tắt:** Cuốn workbook cung cấp bài tập, kỹ thuật thở, tiếp xúc dần (exposure), và công cụ CBT để giảm triệu chứng lo âu và phobia.

### Nội dung chính
- 🫁 **Kỹ thuật thở và thư giãn**
- 🔄 **Tiếp xúc dần và quản lý kích thích**
- 📅 **Kế hoạch hành động cá nhân**

😊 **Mood:** Lo lắng, Bình yên
`,
	},
	{
		_id: 'book-20',
...
> **Tóm tắt:** Tolle khuyến khích tách rời bản ngã khỏi suy nghĩ để sống trọn vẹn ở hiện tại, từ đó giảm căng thẳng và tìm bình yên.

### Nội dung chính
- 👤 **Nhận diện bản ngã**
- 🧘 **Thực hành chánh niệm hàng ngày**
- 🚫 **Giải phóng khỏi nỗi sợ về quá khứ và tương lai**
...
> **Tóm tắt:** Brené Brown bàn về sức mạnh của sự tổn thương và cách can đảm thể hiện bản thân để tăng cường kết nối và hạnh phúc.

### Nội dung chính
- 💪 **Giá trị của tổn thương**
- 🛡️ **Xây dựng lòng can đảm và tự chấp nhận**
- 🤝 **Áp dụng trong gia đình, công việc và cộng đồng**
...
> **Tóm tắt:** Cuốn sách cung cấp bài tập chánh niệm dễ tiếp cận cho người mới bắt đầu và người muốn duy trì thực hành hàng ngày để tìm sự bình lặng.

### Nội dung chính
- 🧘 **Bài tập chánh niệm ngắn**
- 💼 **Tích hợp chánh niệm vào công việc và sinh hoạt**
...
> **Tóm tắt:** Cuốn sách phân loại các kiểu gắn bó (an toàn, lo lắng, tránh né) và đưa ra chiến lược để cải thiện giao tiếp, giảm xung đột và xây dựng mối quan hệ bền vững.

### Nội dung chính
- 🔍 **Nhận diện kiểu gắn bó của bản thân**
- 💬 **Chiến lược giao tiếp theo từng kiểu**
- 📝 **Bài tập thực hành cho cặp đôi**
